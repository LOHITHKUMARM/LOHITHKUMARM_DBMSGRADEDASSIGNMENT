	...
	// A. Inserting 5 Records
       public void CreationAndInsertion() throws SQLException {
    	   try {
   			...
   			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/GL?useSSL=false","root","2906"); 
   			...
   			String query1 = "insert into Employee values(1, \"Jatin Thakur\", \"jatinThakur@gamil.com\", \"9848321657\") ";
   			String query2 = "insert into Employee values(2, \"Prateek Sen\", \"prateeksen@gamil.com\", \"9561234156\")";
   			String query3 = "insert into Employee values(3, \"Ramesh Singh\", \"rameshsingh@gamil.com\", \"9686805871\")";
       ...
       public void InsertingTwoRecords() throws SQLException{
    	   try {
    		   ...
    		   st=con.createStatement();
    		   ResultSet res = null;
    		   String query1="insert into Employee values(6,\"Raj\",\"raj@gmail.com\",\"9142175423\")";
    		   String query2="insert into Employee values(7,\"Shamnth\",\"shamanth@gmail.com\",\"9682134526\")";
